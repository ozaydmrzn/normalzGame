...
enum Constants {
    static let backgroundColor = Color(red: 0.1, green: 0.1, blue: 0.3)
    static let buttonColor = Color(red: 0.2, green: 0.5, blue: 0.8)
...
struct ContentView: View {
    ...
    private var gameView: some View {
        ZStack {
            ...
            VStack(spacing: 20) {
                TitleView(currentStreak: currentStreak)
                if isLoading {
                    ProgressView()
